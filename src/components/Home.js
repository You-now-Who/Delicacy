    ...
    <div className="flex flex-wrap -m-5">
      <div className="p-4 lg:w-1/3">
        ...
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <img class="w-full mb-5 rounded-md" src="https://media.discordapp.net/attachments/941363255874584617/1066635741511286794/photo-1512621776951-a57141f2eefd.png" alt="Mountain"/>
      ...
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <img class="w-full mb-5 rounded-md" src="https://img.freepik.com/free-photo/top-view-table-full-delicious-food-composition_23-2149141353.jpg" alt="Mountain"/>
      ...
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <img class="w-full mb-5 rounded-md" src="https://www.willflyforfood.net/wp-content/uploads/2021/09/ethiopian-food-yetsom-beyaynetu.jpg" alt="Mountain"/>            
